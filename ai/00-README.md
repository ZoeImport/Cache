...
> 本百科是 **love-story** 项目的一部分，所有内容存储在 `/ai/` 目录下。
...
- **可验证**：所有代码和结论经过验证（内部流程：Oracle 审核 + Momus 校验）。
...
**love-story** 是一个个人知识库项目。本 AI/ML 百科是其最新的组成部分，目标是构建一份从零到一的 AI 技术参考。如果你发现了错误或有改进建议，欢迎贡献。
